...
def get_args_parser():
    ...
    parser.add_argument('--log_dir', default = None, type = str, help = 'the log directory of tensorboard')
    parser.add_argument('--enable_wandb', type = str2bool, default = True, help="enable logging to Weights and Biases")
    ...
    parser.add_argument('--data-path', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='IMNET-100', choices=['CIFAR', 'IMNET','IMNET-100' 'INAT', 'INAT19'],
...
def main(args):
    ...
    print("create efficientnet-b1 successfully!\n")
    """
    if args.finetune:
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            fp32=args.fp32_resume, log_writer=log_writer, wandb_logger = wandb_logger
        )
        ...
        test_stats = evaluate(data_loader_val, model, device,wandb_logger=wandb_logger)
        print(f"Accuracy of the network on the {len(dataset_val)} test images: {test_stats['acc1']:.1f}%")
